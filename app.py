...
def load_model():
    ...
    model.load_state_dict(torch.load('model_final_resnet50_bencana.pth', map_location='cpu'))
    model.eval()
    return model
...
if uploaded_file is not None:
    ...
    if label in DANGEROUS_CLASSES:
        ...
        st.write("Gambar ini terdeteksi mengandung unsur bencana atau kerusakan manusia.")
    else:
